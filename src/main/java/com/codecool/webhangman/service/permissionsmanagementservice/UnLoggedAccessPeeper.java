...
@Service
public class UnLoggedAccessPeeper {
    private static final String containerName = "UnLoggedDirectoriesContainer";
    private StaticPermissionsDataContainer staticPermissionsDataContainer;

    public UnLoggedAccessPeeper(StaticPermissionsDataContainer staticPermissionsDataContainer) {
